...
def compute_percentile_rank():
    ...
    cursor.execute("CREATE TABLE Student_FinalScores (Reg_ID Char(11) NOT NULL, Student_Name VARCHAR(40), Total1 INTEGER, Math1 INTEGER, Phy1 INTEGER, Chem1 INTEGER, Total2 INTEGER, Math2 INTEGER, Phy2 INTEGER, Chem2 INTEGER, TP1 FLOAT(10, 7), TP2 FLOAT(10, 7), MP1 FLOAT(10, 7), MP2 FLOAT(10, 7), PP1 FLOAT(10, 7), PP2 FLOAT(10, 7), CP1 FLOAT(10, 7), CP2 FLOAT(10, 7), Total_Percentile FLOAT(10, 7), Math_Percentile FLOAT(10, 7), Phy_Percentile FLOAT(10, 7), Chem_Percentile FLOAT(10, 7), Final_Rank INTEGER, FOREIGN KEY (Reg_ID) REFERENCES Student_master(Reg_ID)  ON DELETE CASCADE, PRIMARY KEY (Reg_ID));")
